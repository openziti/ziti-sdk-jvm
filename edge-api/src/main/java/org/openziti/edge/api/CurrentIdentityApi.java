...
public class CurrentIdentityApi {
   ...
   */
  public CompletableFuture<DetailMfaRecoveryCodesEnvelope> createMfaRecoveryCodes(MfaCode mfaValidation) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = createMfaRecoveryCodesRequestBuilder(mfaValidation);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("createMfaRecoveryCodes", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<DetailMfaRecoveryCodesEnvelope>() {})
              );
            } catch (IOException e) {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<DetailMfaRecoveryCodesEnvelope>> createMfaRecoveryCodesWithHttpInfo(MfaCode mfaValidation) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = createMfaRecoveryCodesRequestBuilder(mfaValidation);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder createMfaRecoveryCodesRequestBuilder(MfaCode mfaValidation) throws ApiException {
    // verify the required parameter 'mfaValidation' is set
    if (mfaValidation == null) {
      throw new ApiException(400, "Missing the required parameter 'mfaValidation' when calling createMfaRecoveryCodes");
    }
  ...
  public CompletableFuture<Empty> deleteMfa(String mfaValidationCode) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("deleteMfa", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<Empty>> deleteMfaWithHttpInfo(String mfaValidationCode) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = deleteMfaRequestBuilder(mfaValidationCode);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder deleteMfaRequestBuilder(String mfaValidationCode) throws ApiException {
  ...
  public CompletableFuture<DetailMfaEnvelope> detailMfa() throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("detailMfa", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<DetailMfaEnvelope>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<DetailMfaEnvelope>> detailMfaWithHttpInfo() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = detailMfaRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  public CompletableFuture<Void> detailMfaQrCode() throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("detailMfaQrCode", localVarResponse));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<Empty> detailMfaRecoveryCodes(String mfaValidationCode, MfaCode mfaValidation) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = detailMfaRecoveryCodesRequestBuilder(mfaValidationCode, mfaValidation);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("detailMfaRecoveryCodes", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<Empty>> detailMfaRecoveryCodesWithHttpInfo(String mfaValidationCode, MfaCode mfaValidation) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = detailMfaRecoveryCodesRequestBuilder(mfaValidationCode, mfaValidation);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder detailMfaRecoveryCodesRequestBuilder(String mfaValidationCode, MfaCode mfaValidation) throws ApiException {
  ...
  public CompletableFuture<CreateEnvelope> enrollMfa() throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("enrollMfa", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<CreateEnvelope>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<CreateEnvelope>> enrollMfaWithHttpInfo() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = enrollMfaRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<CurrentIdentityDetailEnvelope> getCurrentIdentity() throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getCurrentIdentity", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<CurrentIdentityDetailEnvelope>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<CurrentIdentityDetailEnvelope>> getCurrentIdentityWithHttpInfo() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getCurrentIdentityRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ListCurrentIdentityEdgeRoutersEnvelope> getCurrentIdentityEdgeRouters() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getCurrentIdentityEdgeRoutersRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getCurrentIdentityEdgeRouters", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<ListCurrentIdentityEdgeRoutersEnvelope>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<ListCurrentIdentityEdgeRoutersEnvelope>> getCurrentIdentityEdgeRoutersWithHttpInfo() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getCurrentIdentityEdgeRoutersRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  public CompletableFuture<Empty> verifyMfa(MfaCode mfaValidation) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("verifyMfa", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<Empty>> verifyMfaWithHttpInfo(MfaCode mfaValidation) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = verifyMfaRequestBuilder(mfaValidation);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder verifyMfaRequestBuilder(MfaCode mfaValidation) throws ApiException {
    // verify the required parameter 'mfaValidation' is set
    if (mfaValidation == null) {
      throw new ApiException(400, "Missing the required parameter 'mfaValidation' when calling verifyMfa");
    }
