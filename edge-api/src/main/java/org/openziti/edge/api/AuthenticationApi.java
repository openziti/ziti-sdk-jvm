...
public class AuthenticationApi {
   ...
   */
  public CompletableFuture<CurrentApiSessionDetailEnvelope> authenticate(String method, Authenticate auth) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("authenticate", localVarResponse));
            }
            try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<CurrentApiSessionDetailEnvelope>> authenticateWithHttpInfo(String method, Authenticate auth) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = authenticateRequestBuilder(method, auth);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder authenticateRequestBuilder(String method, Authenticate auth) throws ApiException {
    // verify the required parameter 'method' is set
    if (method == null) {
      throw new ApiException(400, "Missing the required parameter 'method' when calling authenticate");
    }
