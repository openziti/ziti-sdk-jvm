...
public class MfaApi {
     ...
     * @throws ApiException if fails to make API call
     */
    public CompletableFuture<DetailMfaRecoveryCodesEnvelope> createMfaRecoveryCodes(
    ...
    public CompletableFuture<ApiResponse<DetailMfaRecoveryCodesEnvelope>>
            createMfaRecoveryCodesWithHttpInfo(MfaCode mfaValidation) throws ApiException {
        try {
            HttpRequest.Builder localVarRequestBuilder =
                    createMfaRecoveryCodesRequestBuilder(mfaValidation);
            return memberVarHttpClient
     ...
     * @throws ApiException if fails to make API call
     */
    public CompletableFuture<Empty> detailMfaRecoveryCodes(
     ...
     * @throws ApiException if fails to make API call
     */
    public CompletableFuture<ApiResponse<Empty>> detailMfaRecoveryCodesWithHttpInfo(
            String mfaValidationCode, MfaCode mfaValidation) throws ApiException {
        try {
            HttpRequest.Builder localVarRequestBuilder =
                    detailMfaRecoveryCodesRequestBuilder(mfaValidationCode, mfaValidation);
