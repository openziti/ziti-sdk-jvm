...
public class MfaApi {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("authenticateMfa", localVarResponse));
            }
            try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<Empty>> authenticateMfaWithHttpInfo(MfaCode mfaAuth) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = authenticateMfaRequestBuilder(mfaAuth);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder authenticateMfaRequestBuilder(MfaCode mfaAuth) throws ApiException {
    ...
    if (mfaAuth == null) {
      throw new ApiException(400, "Missing the required parameter 'mfaAuth' when calling authenticateMfa");
    }
