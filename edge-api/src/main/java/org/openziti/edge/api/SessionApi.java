...
public class SessionApi {
   ...
   */
  public CompletableFuture<SessionCreateEnvelope> createSession(SessionCreate session) throws ApiException {
    try {
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            ...
            try {
              ...
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<SessionCreateEnvelope>() {})
              );
            } catch (IOException e) {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<SessionCreateEnvelope>> createSessionWithHttpInfo(SessionCreate session) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = createSessionRequestBuilder(session);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder createSessionRequestBuilder(SessionCreate session) throws ApiException {
    // verify the required parameter 'session' is set
    if (session == null) {
      throw new ApiException(400, "Missing the required parameter 'session' when calling createSession");
    }
  ...
  public CompletableFuture<Empty> deleteSession(String id) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("deleteSession", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<Empty>> deleteSessionWithHttpInfo(String id) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = deleteSessionRequestBuilder(id);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder deleteSessionRequestBuilder(String id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deleteSession");
    }
  ...
  public CompletableFuture<DetailSessionEnvelope> detailSession(String id) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("detailSession", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<DetailSessionEnvelope>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<DetailSessionEnvelope>> detailSessionWithHttpInfo(String id) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = detailSessionRequestBuilder(id);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder detailSessionRequestBuilder(String id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling detailSession");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ListSessionsEnvelope> listSessions(Integer limit, Integer offset, String filter) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = listSessionsRequestBuilder(limit, offset, filter);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("listSessions", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<ListSessionsEnvelope>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<ListSessionsEnvelope>> listSessionsWithHttpInfo(Integer limit, Integer offset, String filter) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = listSessionsRequestBuilder(limit, offset, filter);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder listSessionsRequestBuilder(Integer limit, Integer offset, String filter) throws ApiException {
