...
public class PostureResponseEndpointStateCreate extends PostureResponseCreate {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PostureResponseEndpointStateCreate postureResponseEndpointStateCreate = (PostureResponseEndpointStateCreate) o;
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getUnlocked() != null) {
      joiner.add(String.format("%sunlocked%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUnlocked()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `woken` to the URL query string
    if (getWoken() != null) {
      joiner.add(String.format("%swoken%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getWoken()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
