...
public class RouterExtendEnrollmentRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RouterExtendEnrollmentRequest routerExtendEnrollmentRequest = (RouterExtendEnrollmentRequest) o;
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCertCsr() != null) {
      joiner.add(String.format("%scertCsr%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCertCsr()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `serverCertCsr` to the URL query string
    if (getServerCertCsr() != null) {
      joiner.add(String.format("%sserverCertCsr%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getServerCertCsr()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
