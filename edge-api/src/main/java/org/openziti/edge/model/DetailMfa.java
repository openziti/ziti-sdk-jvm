...
public class DetailMfa {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, createdAt, id, tags, updatedAt, isVerified, provisioningUrl, recoveryCodes);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIsVerified() != null) {
      joiner.add(String.format("%sisVerified%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIsVerified()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `provisioningUrl` to the URL query string
    if (getProvisioningUrl() != null) {
      joiner.add(String.format("%sprovisioningUrl%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getProvisioningUrl()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getRecoveryCodes() != null) {
      for (int i = 0; i < getRecoveryCodes().size(); i++) {
        joiner.add(String.format("%srecoveryCodes%s%s=%s", prefix, suffix,
            ...
            URLEncoder.encode(String.valueOf(getRecoveryCodes().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
