...
public class NonceSignature {
    ...
    public NonceSignature algorithm(String algorithm) {
    ...
    public NonceSignature caPool(String caPool) {
        this.caPool = caPool;
        return this;
    }
    ...
    public NonceSignature kid(String kid) {
        this.kid = kid;
        return this;
    }
    ...
    public NonceSignature signature(String signature) {
