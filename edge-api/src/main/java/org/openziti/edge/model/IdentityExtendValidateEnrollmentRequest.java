 ...
 */
@JsonPropertyOrder({
  IdentityExtendValidateEnrollmentRequest.JSON_PROPERTY_CLIENT_CERT
})
...
public class IdentityExtendValidateEnrollmentRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IdentityExtendValidateEnrollmentRequest identityExtendValidateEnrollmentRequest = (IdentityExtendValidateEnrollmentRequest) o;
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getClientCert() != null) {
      joiner.add(String.format("%sclientCert%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getClientCert()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
