  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPostureQueryType() != null) {
      joiner.add(String.format("%spostureQueryType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getPostureQueryType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
