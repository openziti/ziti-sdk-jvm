...
public class PostureQuery {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, createdAt, id, tags, updatedAt, isPassing, process, processes, queryType, timeout, timeoutRemaining);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIsPassing() != null) {
      joiner.add(String.format("%sisPassing%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIsPassing()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getTimeoutRemaining() != null) {
      joiner.add(String.format("%stimeoutRemaining%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTimeoutRemaining()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
