...
public class CurrentApiSessionCertificateDetail {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CurrentApiSessionCertificateDetail currentApiSessionCertificateDetail = (CurrentApiSessionCertificateDetail) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, createdAt, id, tags, updatedAt, certificate, fingerprint, subject, validFrom, validTo);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getValidFrom() != null) {
      joiner.add(String.format("%svalidFrom%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getValidFrom()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `validTo` to the URL query string
    if (getValidTo() != null) {
      joiner.add(String.format("%svalidTo%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getValidTo()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
