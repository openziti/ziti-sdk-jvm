...
public class PostureResponseProcessCreate extends PostureResponseCreate {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PostureResponseProcessCreate postureResponseProcessCreate = (PostureResponseProcessCreate) o;
    return Objects.equals(this.hash, postureResponseProcessCreate.hash) &&
        ...
        Objects.equals(this.signerFingerprints, postureResponseProcessCreate.signerFingerprints) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("    signerFingerprints: ").append(toIndentedString(signerFingerprints)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSignerFingerprints() != null) {
      for (int i = 0; i < getSignerFingerprints().size(); i++) {
        joiner.add(String.format("%ssignerFingerprints%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            URLEncoder.encode(String.valueOf(getSignerFingerprints().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
