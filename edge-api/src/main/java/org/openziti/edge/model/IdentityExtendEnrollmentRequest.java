 ...
 */
@JsonPropertyOrder({
  IdentityExtendEnrollmentRequest.JSON_PROPERTY_CLIENT_CERT_CSR
})
...
public class IdentityExtendEnrollmentRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IdentityExtendEnrollmentRequest identityExtendEnrollmentRequest = (IdentityExtendEnrollmentRequest) o;
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getClientCertCsr() != null) {
      joiner.add(String.format("%sclientCertCsr%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getClientCertCsr()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
