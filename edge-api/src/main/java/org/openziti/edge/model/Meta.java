...
public class Meta {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    apiEnrollmentVersion: ").append(toIndentedString(apiEnrollmentVersion)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getApiEnrollmentVersion() != null) {
      joiner.add(String.format("%sapiEnrollmentVersion%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getApiEnrollmentVersion()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getFilterableFields() != null) {
      for (int i = 0; i < getFilterableFields().size(); i++) {
        joiner.add(String.format("%sfilterableFields%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            URLEncoder.encode(String.valueOf(getFilterableFields().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
