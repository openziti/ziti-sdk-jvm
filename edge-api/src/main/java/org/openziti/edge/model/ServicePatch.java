...
public class ServicePatch {
  ...
  public ServicePatch configs(List<String> configs) {
  ...
  **/
  ...
  public ServicePatch encryptionRequired(Boolean encryptionRequired) {
  ...
  **/
  ...
  public ServicePatch maxIdleTimeMillis(Integer maxIdleTimeMillis) {
  ...
  **/
  ...
  public ServicePatch roleAttributes(List<String> roleAttributes) {
  ...
  **/
  ...
  public ServicePatch tags(Tags tags) {
    this.tags = tags;
    return this;
  }
  ...
  **/
  ...
  public ServicePatch terminatorStrategy(String terminatorStrategy) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(configs, encryptionRequired, maxIdleTimeMillis, name, roleAttributes, tags, terminatorStrategy);
  }
  ...
  public String toString() {
    ...
    sb.append("    maxIdleTimeMillis: ").append(toIndentedString(maxIdleTimeMillis)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    roleAttributes: ").append(toIndentedString(roleAttributes)).append("\n");
    sb.append("    tags: ").append(toIndentedString(tags)).append("\n");
    sb.append("    terminatorStrategy: ").append(toIndentedString(terminatorStrategy)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getConfigs() != null) {
      for (int i = 0; i < getConfigs().size(); i++) {
        joiner.add(String.format("%sconfigs%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            URLEncoder.encode(String.valueOf(getConfigs().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }

    // add `encryptionRequired` to the URL query string
    if (getEncryptionRequired() != null) {
      joiner.add(String.format("%sencryptionRequired%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getEncryptionRequired()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `maxIdleTimeMillis` to the URL query string
    if (getMaxIdleTimeMillis() != null) {
      joiner.add(String.format("%smaxIdleTimeMillis%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMaxIdleTimeMillis()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getTerminatorStrategy() != null) {
      joiner.add(String.format("%sterminatorStrategy%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTerminatorStrategy()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
