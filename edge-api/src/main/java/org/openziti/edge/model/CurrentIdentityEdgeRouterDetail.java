...
public class CurrentIdentityEdgeRouterDetail {
  ...
  **/
  ...
  public CurrentIdentityEdgeRouterDetail supportedProtocols(Map<String, String> supportedProtocols) {
    this.supportedProtocols = supportedProtocols;
    return this;
  }

  public CurrentIdentityEdgeRouterDetail putSupportedProtocolsItem(String key, String supportedProtocolsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CurrentIdentityEdgeRouterDetail currentIdentityEdgeRouterDetail = (CurrentIdentityEdgeRouterDetail) o;
    return Objects.equals(this.links, currentIdentityEdgeRouterDetail.links) &&
        ...
        Objects.equals(this.supportedProtocols, currentIdentityEdgeRouterDetail.supportedProtocols) &&
        Objects.equals(this.syncStatus, currentIdentityEdgeRouterDetail.syncStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, createdAt, id, tags, updatedAt, appData, cost, disabled, hostname, isOnline, name, noTraversal, supportedProtocols, syncStatus);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNoTraversal() != null) {
      joiner.add(String.format("%snoTraversal%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getNoTraversal()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `supportedProtocols` to the URL query string
    if (getSupportedProtocols() != null) {
      for (String _key : getSupportedProtocols().keySet()) {
        joiner.add(String.format("%ssupportedProtocols%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, _key, containerSuffix),
            getSupportedProtocols().get(_key), URLEncoder.encode(String.valueOf(getSupportedProtocols().get(_key)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
