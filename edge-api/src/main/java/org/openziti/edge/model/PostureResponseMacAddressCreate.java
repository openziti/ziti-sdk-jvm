 ...
 */
@JsonPropertyOrder({
  PostureResponseMacAddressCreate.JSON_PROPERTY_MAC_ADDRESSES
})
...
public class PostureResponseMacAddressCreate extends PostureResponseCreate {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PostureResponseMacAddressCreate postureResponseMacAddressCreate = (PostureResponseMacAddressCreate) o;
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMacAddresses() != null) {
      for (int i = 0; i < getMacAddresses().size(); i++) {
        joiner.add(String.format("%smacAddresses%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            URLEncoder.encode(String.valueOf(getMacAddresses().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
