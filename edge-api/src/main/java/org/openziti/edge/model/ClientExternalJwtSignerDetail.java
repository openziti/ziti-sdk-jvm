...
public class ClientExternalJwtSignerDetail {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ClientExternalJwtSignerDetail clientExternalJwtSignerDetail = (ClientExternalJwtSignerDetail) o;
    return Objects.equals(this.links, clientExternalJwtSignerDetail.links) &&
        ...
        Objects.equals(this.externalAuthUrl, clientExternalJwtSignerDetail.externalAuthUrl) &&
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getExternalAuthUrl() != null) {
      joiner.add(String.format("%sexternalAuthUrl%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getExternalAuthUrl()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
