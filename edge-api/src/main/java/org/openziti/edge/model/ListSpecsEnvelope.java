...
import org.openziti.edge.model.SpecDetail;
 ...
 */
@JsonPropertyOrder({
  ListSpecsEnvelope.JSON_PROPERTY_DATA,
  ListSpecsEnvelope.JSON_PROPERTY_META
})
...
public class ListSpecsEnvelope {
  ...
  private List<SpecDetail> data = new ArrayList<>();
  ...
  public ListSpecsEnvelope data(List<SpecDetail> data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(List<SpecDetail> data) {
    this.data = data;
  }


  public ListSpecsEnvelope meta(Meta meta) {
    this.meta = meta;
    return this;
  }
