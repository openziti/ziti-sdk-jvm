...
public class ApiSessionDetail {
  ...
  public ApiSessionDetail links(Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public ApiSessionDetail createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ApiSessionDetail id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ApiSessionDetail tags(Tags tags) {
    this.tags = tags;
    return this;
  }
  ...
  **/
  ...
  public ApiSessionDetail updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ApiSessionDetail authQueries(List<AuthQueryDetail> authQueries) {
  ...
  **/
  ...
  public ApiSessionDetail authenticatorId(String authenticatorId) {
  ...
  **/
  ...
  public ApiSessionDetail cachedLastActivityAt(OffsetDateTime cachedLastActivityAt) {
  ...
  **/
  ...
  public ApiSessionDetail configTypes(List<String> configTypes) {
  ...
  **/
  ...
  public ApiSessionDetail identity(EntityRef identity) {
  ...
  **/
  ...
  public ApiSessionDetail identityId(String identityId) {
  ...
  **/
  ...
  public ApiSessionDetail ipAddress(String ipAddress) {
  ...
  **/
  ...
  public ApiSessionDetail isMfaRequired(Boolean isMfaRequired) {
  ...
  **/
  ...
  public ApiSessionDetail lastActivityAt(OffsetDateTime lastActivityAt) {
  ...
  **/
  ...
  public ApiSessionDetail token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, createdAt, id, tags, updatedAt, authQueries, authenticatorId, cachedLastActivityAt, configTypes, identity, identityId, ipAddress, isMfaComplete, isMfaRequired, lastActivityAt, token);
  }
