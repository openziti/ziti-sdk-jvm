...
public class ApiSessionDetail {
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(JSON_PROPERTY_IMPROPER_CLIENT_CERT_CHAIN)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(JSON_PROPERTY_IS_CERT_EXTEND_REQUESTED)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(JSON_PROPERTY_IS_CERT_KEY_ROLL_REQUESTED)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
