...
public class PostureQueries {
  ...
  public PostureQueries isPassing(Boolean isPassing) {
  ...
  **/
  ...
  public PostureQueries policyId(String policyId) {
  ...
  **/
  ...
  public PostureQueries policyType(DialBind policyType) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_POLICY_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPolicyType(DialBind policyType) {
    this.policyType = policyType;
  }


  public PostureQueries postureQueries(List<PostureQuery> postureQueries) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_POSTURE_QUERIES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPostureQueries(List<PostureQuery> postureQueries) {
    this.postureQueries = postureQueries;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPolicyId() != null) {
      joiner.add(String.format("%spolicyId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getPolicyId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `policyType` to the URL query string
    if (getPolicyType() != null) {
      joiner.add(String.format("%spolicyType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getPolicyType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
