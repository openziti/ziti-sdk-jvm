...
public class TerminatorClientDetail {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, createdAt, id, tags, updatedAt, identity, routerId, service, serviceId);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getRouterId() != null) {
      joiner.add(String.format("%srouterId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getRouterId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
