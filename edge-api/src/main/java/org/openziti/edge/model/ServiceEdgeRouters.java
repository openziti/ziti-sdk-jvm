...
import org.openziti.edge.model.CommonEdgeRouterProperties;
 ...
 */
@JsonPropertyOrder({
  ServiceEdgeRouters.JSON_PROPERTY_EDGE_ROUTERS
})
...
public class ServiceEdgeRouters {
  ...
  public ServiceEdgeRouters edgeRouters(List<CommonEdgeRouterProperties> edgeRouters) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_EDGE_ROUTERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEdgeRouters(List<CommonEdgeRouterProperties> edgeRouters) {
    this.edgeRouters = edgeRouters;
  }
