...
public class CurrentIdentityApiTest {
     ...
     *
     * <p>Allows regeneration of recovery codes of an MFA enrollment. Requires a current valid time
     * based one time password to interact with. Available after a completed MFA enrollment. This
     ...
     *
     * <p>Disable MFA for the current identity. Requires a current valid time based one time
     * password if MFA enrollment has been completed. If not, code should be an empty string. If one
     * time passwords are not available and admin account can be used to remove MFA from the
     * identity via &#x60;DELETE /identities/&lt;id&gt;/mfa&#x60;.
     *
     * @throws ApiException if the Api call fails
     */
    @Test
    public void deleteMfaTest() throws ApiException {
        ...
        CompletableFuture<Empty> response = api.deleteMfa(mfaValidationCode);
     ...
     *
     * <p>Returns details about the current MFA enrollment. If enrollment has not been completed it
     * will return the current MFA configuration details necessary to complete a &#x60;POST
    ...
    public void detailMfaTest() throws ApiException {
        CompletableFuture<DetailMfaEnvelope> response = api.detailMfa();
     ...
     *
     * <p>Shows an QR code image for unverified MFA enrollments. 404s if the MFA enrollment has been
     ...
     *
     * <p>Allows the viewing of recovery codes of an MFA enrollment. Requires a current valid time
     * based one time password to interact with. Available after a completed MFA enrollment.
     *
     * @throws ApiException if the Api call fails
     */
    @Test
     ...
     *
     * <p>Allows authenticator based MFA enrollment. If enrollment has already been completed, it
     * must be disabled before attempting to re-enroll. Subsequent enrollment request is completed
     * via &#x60;POST /current-identity/mfa/verify&#x60;
     *
     * @throws ApiException if the Api call fails
     */
    @Test
    public void enrollMfaTest() throws ApiException {
        CompletableFuture<CreateEnvelope> response = api.enrollMfa();
     ...
     *
     * <p>Returns the identity associated with the API sessions used to issue the current request
     *
     * @throws ApiException if the Api call fails
     */
    @Test
    public void getCurrentIdentityTest() throws ApiException {
        CompletableFuture<CurrentIdentityDetailEnvelope> response = api.getCurrentIdentity();
     ...
     *
     * <p>Completes MFA enrollment by accepting a time based one time password as verification.
     * Called after MFA enrollment has been initiated via &#x60;POST /current-identity/mfa&#x60;.
     *
     * @throws ApiException if the Api call fails
     */
    @Test
    public void verifyMfaTest() throws ApiException {
        MfaCode mfaValidation = null;
        CompletableFuture<Empty> response = api.verifyMfa(mfaValidation);
